      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div className="flex flex-col items-center md:items-start">
            <span className="text-secondary font-medium tracking-widest uppercase text-[10px] md:text-sm mb-2 block">
              Vybrané Projekty
            </span>
          ...
          <p className="text-gray-400 max-w-md text-sm md:text-lg leading-relaxed">
            Kurátorský výběr našich nejnovějších architektonických vizualizací. Přejeďte myší po kartě pro zobrazení detailů.
          </p>
        </motion.div>

        {/* Mobile Swipe Indicator */}
        <div className="flex md:hidden items-center justify-center gap-2 mb-6 text-gray-500 animate-pulse">
        ...
        <div className="mt-20 flex justify-center">
            ...
            >
                <span className="text-white font-medium">Kontaktujte nás</span>
              ...
              <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
                ...
                >
                  ...
                  <div className="w-full md:w-[60%] flex flex-col shrink-0 border-b md:border-b-0 md:border-r border-white/5 relative bg-black">
                    <div className="relative flex-grow min-h-[30vh] sm:min-h-[35vh] md:min-h-[500px]">
                      <motion.img 
                        ...
                        src={selectedProject.galleryUrls?.[selectedImageIndex] || selectedProject.imageUrl} 
                        alt={`${selectedProject.title} - ${selectedProject.location} - Detail vizualizace`} 
                    ...
                    {selectedProject.galleryUrls && selectedProject.galleryUrls.length > 1 && (
                      <div className="absolute bottom-4 md:bottom-6 left-0 w-full flex justify-center gap-2 md:gap-3 px-4 md:px-6 overflow-x-auto no-scrollbar z-20">
                        {selectedProject.galleryUrls.map((url, idx) => (
                          <button
                            key={idx}
                            onClick={(e) => {
                              e.stopPropagation();
                  ...
                  <div className="w-full md:w-[40%] p-5 sm:p-6 md:p-14 flex flex-col justify-center relative bg-gradient-to-br from-[#0a050a] to-[#050205] overflow-y-auto no-scrollbar">
                    ...
                    <p className="text-gray-400 leading-relaxed text-xs sm:text-sm md:text-base mb-6 md:mb-12 flex-grow">
                      {selectedProject.description}
                    </p>
                    
                    {/* Call to action */}
                    <div className="pt-4 md:pt-6 border-t border-white/5 mt-auto">
                      <p className="text-[10px] md:text-xs text-secondary font-bold tracking-widest uppercase mb-2 md:mb-4">Líbí se vám tento projekt?</p>
                      <a 
                        href="#contact"
                        onClick={() => setSelectedProject(null)}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 z-10">
                 <div className="flex justify-between items-end">
                    <div>
                        <span className="text-secondary text-xs font-bold tracking-widest uppercase mb-2 block">{project.category}</span>
          ...
          >
            ...
            <div className="relative z-10 h-full p-6 md:p-8 flex flex-col overflow-y-auto">
              <div className="flex justify-between items-start mb-4 shrink-0">
                 ...
                 <span className="text-xs uppercase tracking-widest text-gray-300 font-bold drop-shadow-sm bg-[#0a050a]/50 px-2 py-1 rounded backdrop-blur-sm">{project.category}</span>
              </div>
              ...
              <div className="flex-grow flex flex-col justify-center gap-3 md:gap-4 my-2">
                ...
                <p className="text-white leading-relaxed text-sm font-medium drop-shadow-md">
                  {project.description}
                </p>
              </div>
